...
export const userSchema = yup.object({
  name: yup.string().max(160, 'Độ dài tên phải từ 5 đến 160 ký tự'),
  phone: yup.string().max(20, 'Độ dài số điện thoại phải từ 5 đến 20 ký tự'),
  address: yup.string().max(160, 'Độ dài địa chỉ phải từ 5 đến 160 ký tự'),
  avatar: yup.string().max(1000, 'Độ dài ảnh tối đa là 1000 ký tự'),
  date_of_birth: yup.date().max(new Date(), 'Ngày sinh không hợp lệ').required('Ngày sinh là bắt buộc'),
