...
export const userSchema = yup.object({
  name: yup.string().max(160, 'Độ dài tên tối đa là 160 ký tự'),
  phone: yup.string().max(20, 'Độ dài số điện thoại tối đa là 20 ký tự'),
  address: yup.string().max(160, 'Độ dài địa chỉ tối đa 160 ký tự'),
